export const site = {
  ...
  install: {
    macos:   { prereq: 'Requires Python 3.10+ and a microphone.', cmd: 'curl -fsSL https://voice-assistant.example.com/install.sh | bash', run: 'voice-assistant', note: 'Default hotkey: ctrl+shift+space.' },
    linux:   { prereq: 'Requires Python 3.10+, portaudio, and espeak-ng.', cmd: 'curl -fsSL https://voice-assistant.example.com/install.sh | bash', run: 'voice-assistant', note: 'Default hotkey: ctrl+shift+space.' },
    windows: { prereq: 'Requires Python 3.10+ and a microphone.', cmd: 'iwr -useb https://voice-assistant.example.com/install.ps1 | iex', run: 'voice-assistant', note: 'Default hotkey: ctrl+shift+space.' },
  },
  safety: [
